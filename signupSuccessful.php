    ...
    <body class="bg-gray-50 dark:bg-gray-900 flex items-center justify-center h-screen">
        <div class="max-w-sm w-full bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8">
            ...
            <form action="signupSuccessful.php" method="POST" class="space-y-6">
                <div>
                    <h2 class="text-2xl font-semibold text-center text-gray-900 dark:text-white">Verification email sent!</h2>
                ...
                <div>
                    <p class="mb-3 text-xs text-center text-gray-900 dark:text-white">You can resend the email if you didn't recieve it.</p>
                    ...
                    <button type="submit" class="secondary-color-fsystems w-full text-white py-2 rounded-md shadow-md focus:outline-none focus:ring-2 focus:ring-opacity-50">
                    Resend email
                    </button>
                </div>
            </form>
